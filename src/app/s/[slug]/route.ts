...
export async function GET(
  ...
  if (html.includes('</head>')) {
    ...
    const fix = `<style id="bethel-fix">${headerRule}header img{height:72px !important;width:auto !important}#servicos,#servicos *{text-align:center !important}.btn-cta{display:block !important;width:fit-content !important;max-width:100% !important;margin-left:auto !important;margin-right:auto !important}</style>`
