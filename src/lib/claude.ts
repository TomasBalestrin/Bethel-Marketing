...
3. <section id="servicos"> — título e subtítulo da seção CENTRALIZADOS (text-align:center), cards dos serviços contendo APENAS o título do serviço e a descrição. NÃO use ícones, emojis, símbolos nem imagens nos cards de serviço — visual limpo e profissional, só texto (título + descrição). OBRIGATÓRIO: quando um serviço tiver descrição fornecida, copie o texto EXATAMENTE como está — é terminantemente proibido parafrasear, resumir, reescrever ou alterar a descrição de qualquer serviço.
